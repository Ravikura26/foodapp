                ...
                <View className="bg-[#Fff min-h-screen flex-1 ">
                    ...
                    <View className="p-2">
                        ...
                        <View className="mt-2">
                            ...
                            <Text className="text-lg font-bold text-gray-800">Opening Hours:</Text>
                            <Text className="text-lg border-b-2 border-red-300 text-gray-600 mb-2">{restaurant?.openingTime}</Text>
 
                        </View>
                        {/* Action Buttons */}
                        <View className="mt-5 flex "> 
                            <TouchableOpacity onPress={()=>{router.push({pathname:'/restaurant-profile/res-update',
                    params:{
